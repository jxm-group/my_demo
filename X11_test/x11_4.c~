...
Screen *	screen = ScreenOfDisplay(dpy, screen_number);
  ...
  // 创建 200X200 的白色背景窗口
  attributes.background_pixel = BlackPixelOfScreen(screen);//XWhitePixel(dpy, 0);  
 ...
 long  eventMask =		KeyPressMask | KeyReleaseMask | 
	...
	xevent.xclient.message_type = XInternAtom(dpy, "_NET_WM_MOVERESIZE", False);;
	...
	XSendEvent(	dpy, 
			RootWindowOfScreen(screen), False,  
